...
void u8g2_Setup_mn28016a_280x16_f(u8g2_t* u8g2,
                                  const u8g2_cb_t* rotation,
                                  u8x8_msg_cb byte_cb,
                                  u8x8_msg_cb gpio_and_delay_cb) {
    static uint8_t tile_buf_height = 16 / 8;
    static uint8_t buffers[280 * 16 / 8];  // 560个字节
    u8g2_SetupDisplay(u8g2, u8x8_d_vfd_mn28016a, u8x8_cad_empty, byte_cb,
                      gpio_and_delay_cb);
    u8g2_SetupBuffer(u8g2, buffers, tile_buf_height,
